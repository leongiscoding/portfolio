      ...
      <div className="flex flex-col gap-4">
        {actions.map(({ label, href, icon }) => (
          <a
            ...
            aria-label={label}
            className="w-10 h-10 rounded-full glass-card flex items-center justify-center text-white/60 hover:bg-brand-accent hover:text-white transition-all duration-200"
          >
            {icon}
          </a>
        ))}
